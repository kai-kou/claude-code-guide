...
| パターン | 出現回数 | 関連スプリント |
|---------|---------|-------------|
| SP消化率100% | 8 | SPRINT-001〜SPRINT-008（全スプリント） |
...
|---------|---------|-------------|---------------|
| timing記録の未実施 | 6 | SPRINT-002, SPRINT-003, SPRINT-005〜SPRINT-008 | タスク実行に集中するとtiming記録を忘れる |
| Slack投稿の未実施 | 6 | SPRINT-003〜SPRINT-008 | Slack MCP接続が不安定でワークフローに組み込めていない |
