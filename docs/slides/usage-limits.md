...
|--------|-----------|-----------|
| Pro | 約10〜40プロンプト | 標準 |
| Max 5x | Proの約5倍（目安） | Proの約5倍（目安） |
| Max 20x | Proの約20倍（目安） | Proの約20倍（目安） |

**Max 5x/20x 倍率に関する注意点**:
- 「5倍」「20倍」は**目安であり、正確な比例ではない**
- **5時間ウィンドウ**: おおむね倍率通りの制限
- **週間Sonnet枠**: 実質3.5〜6倍程度にばらつきがある
- **Opus独立キャップ**: Max 5xでも週15〜35h程度と制限が厳しい
- **Opusのコンピュートコスト**: Sonnetの約5倍のため、同じ倍率でもOpusの方が早く制限に到達する
- 利用パターンやサーバー負荷によって動的に変動する
